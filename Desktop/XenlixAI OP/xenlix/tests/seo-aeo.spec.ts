...
test.describe('SEO/AEO Functionality', () => {
  ...
  test('should display AEO guidance', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="aeo-guidance"], .guidance-section:has-text("AEO")')).toBeVisible();
  ...
  test('should display Traditional SEO guidance', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="seo-guidance"], .guidance-section:has-text("Traditional SEO")')).toBeVisible();
