...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const mergedData: NormalizedBusiness = {
      ...
      ...(extractionResult.data.rating !== undefined || normalizedFallback.rating !== undefined) && { 
        rating: extractionResult.data.rating !== undefined ? extractionResult.data.rating : normalizedFallback.rating 
      },
      ...(extractionResult.data.reviewCount !== undefined || normalizedFallback.reviewCount !== undefined) && { 
        reviewCount: extractionResult.data.reviewCount !== undefined ? extractionResult.data.reviewCount : normalizedFallback.reviewCount 
      },
